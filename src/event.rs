...
impl NearEvent {
    ...
    pub fn log_nft_mint(owner_id: String, token_ids: Vec<String>, memo: Option<String>, metadata: TokenMetadata) {
        NearEvent::log_nft_mints(vec![NftMintData { owner_id, token_ids, memo, metadata }]);
    }
